...
def main():
    ...
    ap.add_argument("--out_splits", default="sota_cv_test_metrics_two.csv")
    ap.add_argument("--out_summary", default="sota_cv_test_summary_two.csv")
    ap.add_argument("--out_ci", default="sota_ci_summary_two_sota_two.csv")
    ap.add_argument("--out_ee", default="sota_early_enrichment_two.csv")
    ap.add_argument("--n_boot", type=int, default=2000)
    ap.add_argument("--alpha", type=float, default=0.95)
    # multiview kontrolleri
    ap.add_argument("--list_number", type=int, default=2,
