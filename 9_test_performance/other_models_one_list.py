...
def main():
    ...
    ap.add_argument("--out_splits", default="model_cv_test_metrics_other_one.csv")
    ap.add_argument("--out_summary", default="model_cv_test_summary_other_one.csv")
    ap.add_argument("--out_ci", default="model_ci_summary_other_one.csv")
    ap.add_argument("--out_ee", default="model_early_enrichment_other_one.csv")
    ap.add_argument("--n_boot", type=int, default=2000)
    ap.add_argument("--alpha", type=float, default=0.95)
    # multiview controls
    ap.add_argument("--list_number", type=int, default=1, help="Use first N lists among list_1..list_4 (ignored if --views is provided)")
